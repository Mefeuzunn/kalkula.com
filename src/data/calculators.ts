...
export const calculators: CalculatorInfo[] = [
  ...
  // Finans ve Kredi (Profesyonel Bankacılık Serisi)
  ...
  { id: "ihtiyac-kredisi", title: "İhtiyaç Kredisi Hesaplama", slug: "ihtiyac-kredisi", categoryId: "kredi", description: "İhtiyaç kredisi taksit ve toplam maliyetini KKDF/BSMV dahil hesaplayın." },
  { id: "konut-kredisi", title: "Konut Kredisi Hesaplama", slug: "konut-kredisi", categoryId: "kredi", description: "Ev alımı için mortgage ve konut kredisi ödeme planınızı oluşturun." },
  { id: "tasit-kredisi", title: "Taşıt Kredisi Hesaplama", slug: "tasit-kredisi", categoryId: "kredi", description: "Sıfır veya ikinci el araçlar için taşıt kredisi maliyet analizi." },
  { id: "ticari-kredi", title: "Ticari Kredi Hesaplama", slug: "ticari-kredi", categoryId: "kredi", description: "KOBİ ve işletmelere özel ticari kredi faiz ve taksit hesabı." },
  { id: "kredikarti-asgari", title: "Kredi Kartı Asgari Ödeme", slug: "kredi-karti-asgari", categoryId: "kredi", description: "Mevcut borcunuza göre ödemeniz gereken minimum asgari tutar." },
  { id: "kredikarti-taksit", title: "Kredi Kartı Ek Taksit", slug: "kredi-karti-ek-taksit", categoryId: "kredi", description: "Tek çekim harcamalarınızı sonradan taksitlendirmenin maliyetini bulun." },
  { id: "kredikarti-nakit", title: "Taksitli Nakit Avans", slug: "kredi-karti-taksitli-nakit-avans", categoryId: "kredi", description: "Kredi kartından taksitli nakit çekim ücreti ve faiz maliyeti." },
  { id: "kredi-apr", title: "Kredi Yıllık Maliyet Oranı", slug: "kredi-yillik-maliyet-orani", categoryId: "kredi", description: "Dosya masrafı ve sigorta dahil kredinin gerçek yıllık maliyetini (APR) görün." },
  { id: "kredi-eligibility", title: "Ne Kadar Kredi Alabilirim?", slug: "ne-kadar-kredi-alabilirim", categoryId: "kredi", description: "Gelirinize ve giderlerinize göre bankalardan alabileceğiniz maksimum kredi limiti." },
  { id: "kredi-early", title: "Kredi Erken Kapatma Cezası", slug: "kredi-erken-kapatma", categoryId: "kredi", description: "Kredinizi erken ödediğinizde ödeyeceğiniz ceza ve kâr analizi." },
  { id: "kredi-fees", title: "Kredi Dosya Masrafı", slug: "kredi-dosya-masrafi", categoryId: "kredi", description: "Kredi tahsis ücreti ve diğer yasal masrafların limitlerini hesaplayın." },
  { id: "kredi-late", title: "Kredi Gecikme Faizi", slug: "kredi-gecikme-faizi", categoryId: "kredi", description: "Taksit ödemesinin gecikmesi durumunda uygulanacak temerrüt faizini bulun." },
  { id: "kredi-refinance", title: "Kredi Yapılandırma", slug: "kredi-yapilandirma", categoryId: "kredi", description: "Eski kredinizi yeni faiz oranlarıyla yapılandırmanın avantajını hesaplayın." },
  { id: "isyeri-kredi", title: "İş Yeri Kredisi Hesaplama", slug: "is-yeri-kredisi", categoryId: "kredi", description: "Ticari gayrimenkul ve iş yeri alımları için kredi maliyet tablosu." },
  { id: "ticari-tasit", title: "Ticari Araç Kredisi", slug: "ticari-arac-kredisi", categoryId: "kredi", description: "Şirket adına alınan ticari araçların kredi ve vergi avantajlı dökümü." },
  { id: "ticari-ihtiyac", title: "Ticari İhtiyaç Kredisi", slug: "ticari-ihtiyac-kredisi", categoryId: "kredi", description: "İşletme sermayesi ve kısa vadeli ticari nakit ihtiyaçları için kredi hesabı." },
  { id: "kredi-odeme-plani", title: "Kredi Ödeme Planı (Amortizasyon)", slug: "kredi-odeme-plani", categoryId: "kredi", description: "Ay bazlı anapara ve faiz dökümünü içeren detaylı kredi taksit tablosu." },
  ...
  { id: "asi-takvimi", title: "Aşı Takvimi Hesaplama", slug: "asi-takvimi", categoryId: "saglik", description: "Bebeğinizin doğum tarihine göre Sağlık Bakanlığı uyumlu aşı takvimi." },
  { id: "bebek-gelisimi", title: "Bebek Boy/Kilo (Persentil)", slug: "bebek-gelisimi", categoryId: "saglik", description: "Bebeğinizin boy ve kilo gelişimini WHO standartlarında takip edin." },
  { id: "bel-kalca", title: "Bel / Kalça Oranı", slug: "bel-kalca-orani", categoryId: "saglik", description: "Vücut yağ dağılımınızı ve sağlık riskinizi bel/kalça oranıyla ölçün." },
  { id: "dogum-tarihi", title: "Doğum Tarihi Hesaplama", slug: "dogum-tarihi", categoryId: "saglik", description: "Son adet tarihinize göre tahmini doğum günü ve gebelik haftası." },
  { id: "protein", title: "Günlük Protein İhtiyacı", slug: "protein-ihtiyaci", categoryId: "saglik", description: "Vücut ağırlığınıza ve aktivite seviyenize göre gereken protein miktarı." },
  { id: "karb", title: "Günlük Karbonhidrat İhtiyacı", slug: "karbonhidrat-ihtiyaci", categoryId: "saglik", description: "Günlük enerji ihtiyacınızı karşılayacak sağlıklı karbonhidrat miktarı." },
  { id: "yag", title: "Günlük Yağ İhtiyacı", slug: "yag-ihtiyaci", categoryId: "saglik", description: "Hormonal denge ve sağlık için tüketilmesi gereken yağ miktarı." },
  { id: "kreatin", title: "Günlük Kreatin Dozu", slug: "kreatin-dozu", categoryId: "saglik", description: "Vücut ağırlığına göre yükleme ve koruma dönemi kreatin ihtiyacı." },
  { id: "sigara-maly", title: "Sigara Maliyeti Hesaplama", slug: "sigara-maliyeti", categoryId: "saglik", description: "Sigaraya harcanan paranın aylık, yıllık ve toplam ekonomik kaybı." },
  ...
  { id: "altin", title: "Altın Hesaplama", slug: "altin-hesaplama", categoryId: "finans", description: "Gram, çeyrek ve tam altın birimlerini anlık kurlarla TL'ye çevirin." },
  { id: "cagr", title: "Bileşik Büyüme (CAGR)", slug: "bilesik-buyume", categoryId: "finans", description: "Yatırımınızın belirli bir dönemdeki yıllık bileşik büyüme oranını hesaplayın." },
  { id: "birikim", title: "Birikim Hesaplama", slug: "birikim-hesaplama", categoryId: "finans", description: "Düzenli tasarruflarınızın gelecekteki toplam değerini projeksiyonla görün." },
  { id: "bono", title: "Bono Hesaplama", slug: "bono-hesaplama", categoryId: "finans", description: "Hazine bonosu ve iskontolu kağıtların getiri ve fiyat analizini yapın." },
  { id: "doviz", title: "Döviz Hesaplama", slug: "doviz-hesaplama", categoryId: "finans", description: "Dolar, Euro ve diğer para birimleri arasında anlık kur dönüşümü yapın." },
  { id: "enflasyon", title: "Enflasyon Hesaplama", slug: "enflasyon-hesaplama", categoryId: "finans", description: "Paranın yıllar içindeki alım gücü kaybını ve enflasyon etkisini analiz edin." },
  { id: "eurobond", title: "Eurobond Hesaplama", slug: "eurobond-hesaplama", categoryId: "finans", description: "Eurobond kupon getirilerini ve vergi sonrası net kazancınızı hesaplayın." },
  { id: "faiz", title: "Faiz Hesaplama", slug: "faiz-hesaplama", categoryId: "finans", description: "Anapara ve faiz oranına göre brüt ve net mevduat getirisi hesabı." },
  { id: "gecmis_altin", title: "Geçmiş Altın Fiyatları", slug: "gecmis-altin-fiyatlari", categoryId: "finans", description: "Seçilen tarihteki altın fiyatlarını ve bugüne oranla değişimini görün." },
  { id: "gecmis_doviz", title: "Geçmiş Döviz Kurları", slug: "gecmis-doviz-kurlari", categoryId: "finans", description: "Geçmişe dönük döviz kurlarını sorgulayın ve kur farkı analizi yapın." },
  { id: "iban", title: "IBAN Doğrulama", slug: "iban-dogrulama", categoryId: "finans", description: "IBAN numarasının matematiksel olarak geçerli olup olmadığını kontrol edin." },
  { id: "iskonto", title: "İç ve Dış İskonto", slug: "iskonto-hesaplama", categoryId: "finans", description: "Senet kırdırma işlemlerinde iç ve dış iskonto farkını hesaplayın." },
  { id: "irr", title: "İç Verim Oranı (IRR)", slug: "irr-hesaplama", categoryId: "finans", description: "Bir yatırım projesinin yıllık iç verim oranını (IRR) hesaplayın." },
  { id: "kira", title: "Kira Artış Oranı", slug: "kira-artis-orani", categoryId: "finans", description: "Yasal TÜFE sınırlarına göre maksimum kira artış tutarını hesaplayın." },
  { id: "npv", title: "Net Bugünkü Değer (NPV)", slug: "npv-hesaplama", categoryId: "finans", description: "Gelecekteki nakit akışlarının bugünkü net parasal değerini (NPV) bulun." },
  { id: "ort_vade", title: "Ortalama Vade", slug: "ortalama-vade-hesaplama", categoryId: "finans", description: "Çek ve senet portföyünüzün ağırlıklı ortalama vadesini gün bazlı bulun." },
  { id: "para_deger", title: "Parasal Değer", slug: "parasal-deger-hesaplama", categoryId: "finans", description: "Farklı tarihlerdeki paranın enflasyon karşısındaki reel değerini ölçün." },
  { id: "reel_getiri", title: "Reel Getiri", slug: "reel-getiri-hesaplama", categoryId: "finans", description: "Yatırımınızın enflasyondan arındırılmış gerçek kazancını hesaplayın." },
  { id: "repo", title: "Repo Hesaplama", slug: "repo-hesaplama", categoryId: "finans", description: "Gecelik veya vadeli repo getirilerini net ve brüt olarak görün." },
  { id: "temettu", title: "Sermaye ve Temettü", slug: "temettu-hesaplama", categoryId: "finans", description: "Hisse senedi yatırımlarınızın temettü verimi ve ödeme analizini yapın." },
  { id: "tahvil", title: "Tahvil Hesaplama", slug: "tahvil-hesaplama", categoryId: "finans", description: "Kuponlu devlet tahvillerinin pazar fiyatı ve verim analizini gerçekleştirin." },
  { id: "vadeli_islem", title: "Vadeli İşlem Fiyatı", slug: "vadeli-islem-fiyat-hesaplama", categoryId: "finans", description: "Dayanak varlığın vadedeki teorik fiyatını (Futures) hesaplayın." },
  { id: "vadeli_mevduat", title: "Vadeli Mevduat Faizi", slug: "mevduat-faizi-hesaplama", categoryId: "finans", description: "Banka mevduat hesaplarının vade sonu net getiri projeksiyonu." },
